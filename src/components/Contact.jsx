          ...
          <div className="bg-white relative flex flex-wrap py-6 rounded shadow-md">
            ...
            <div className="lg:w-1/2 px-6 mt-4 lg:mt-0">
              ...
              <a className="text-indigo-400 leading-relaxed">
                nadisonsolojeanfidelys@gmail.com
              </a>
              <h2 className="title-font font-semibold text-white tracking-widest text-xs mt-4">
                PHONE
              </h2>
              <p className="leading-relaxed">+33 (0)7 80 26 69 98</p>
            </div>
          </div>
        </div>
        <form
          ...
          <p className="leading-relaxed mb-5">
            N'ésitez pas a appeler sinon vous pouvez me contacter ici directement.
          </p>
          ...
          <button
            type="submit"
            className="text-white bg-purple-800 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg">
            Send
          </button>
        </form>
      </div>
